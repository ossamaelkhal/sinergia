...
const SalesManagementDashboard = ({ onClose }) => {
  ...
  const getLevelColor = (level) => {
    switch(level) {
      case 'Elite': return 'bg-sinergia-vibrant-cyan/20 text-sinergia-vibrant-cyan border-sinergia-vibrant-cyan/30'
      case 'Avançado': return 'bg-sinergia-success-green/20 text-sinergia-success-green border-sinergia-success-green/30'
      case 'Intermediário': return 'bg-sinergia-warning-yellow/20 text-sinergia-warning-yellow border-sinergia-warning-yellow/30'
      case 'Iniciante': return 'bg-sinergia-light-neutral-gray/20 text-sinergia-light-neutral-gray border-sinergia-light-neutral-gray/30'
      default: return 'bg-sinergia-card-bg-light text-sinergia-light-neutral-gray border-sinergia-border-card'
    }
  }
        ...
        <div className="flex items-center justify-between p-6 border-b border-sinergia-border-card">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-sinergia-button rounded-full flex items-center justify-center">
              <Users className="w-6 h-6 text-sinergia-deep-navy" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-white">Gestão de Vendedores</h2>
              <p className="text-sinergia-light-neutral-gray">Dashboard executivo da SinergIA Academy</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <Button variant="outline" size="sm" className="border-sinergia-border-card text-sinergia-light-neutral-gray hover:bg-sinergia-card-bg">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardContent className="p-6 text-center">
                    <Users className="w-8 h-8 text-sinergia-vibrant-cyan mx-auto mb-2" />
                    <div className="text-2xl font-bold text-white">{teamStats.activeSellers}</div>
                    <div className="text-sm text-sinergia-light-neutral-gray">Vendedores Ativos</div>
                    <div className="text-xs text-sinergia-success-green mt-1">+{teamStats.newThisMonth} este mês</div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-sm text-sinergia-light-neutral-gray">Receita Total</div>
                    <div className="text-xs text-sinergia-success-green mt-1">+{teamStats.monthlyGrowth}% vs mês anterior</div>
                  </CardContent>
                </Card>

                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardContent className="p-6 text-center">
                    <Target className="w-8 h-8 text-sinergia-vibrant-cyan mx-auto mb-2" />
                    <div className="text-2xl font-bold text-white">{teamStats.conversionRate}%</div>
                    <div className="text-sm text-sinergia-light-neutral-gray">Taxa de Conversão</div>
                    <div className="text-xs text-sinergia-success-green mt-1">+2.3% vs mês anterior</div>
                  </CardContent>
                </Card>

                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardContent className="p-6 text-center">
                    <TrendingUp className="w-8 h-8 text-sinergia-vibrant-cyan mx-auto mb-2" />
                    <div className="text-2xl font-bold text-white">R$ {teamStats.avgTicket.toLocaleString()}</div>
                    <div className="text-sm text-sinergia-light-neutral-gray">Ticket Médio</div>
                    <div className="text-xs text-sinergia-success-green mt-1">+8.7% vs mês anterior</div>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardHeader>
                    <CardTitle className="text-white flex items-center">
                      <LineChart className="w-5 h-5 mr-2 text-sinergia-vibrant-cyan" />
                      Evolução de Vendas
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <RechartsLineChart data={salesData}>
                        ...
                        <Tooltip 
                          contentStyle={{ 
                            backgroundColor: 'var(--sinergia-card-bg)', 
                            border: '1px solid var(--sinergia-border-card)',
                            borderRadius: '8px'
                          }}
                        />
                        <Line type="monotone" dataKey="vendas" stroke="var(--sinergia-vibrant-cyan)" strokeWidth={3} />
                        <Line type="monotone" dataKey="meta" stroke="var(--sinergia-light-neutral-gray)" strokeWidth={2} strokeDasharray="5 5" />
                      </RechartsLineChart>
                    </ResponsiveContainer>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                  <CardHeader>
                    <CardTitle className="text-white flex items-center">
                      <BarChart3 className="w-5 h-5 mr-2 text-sinergia-vibrant-cyan" />
                        ...
                        <div key={index} className="space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-sinergia-light-neutral-gray text-sm">{team.vendedores} vendedores</div>
                            </div>
                          </div>
                          <Progress value={team.performance} className="h-2 bg-sinergia-vibrant-cyan" />
                        </div>
                      ))}
                    </div>
                  </CardContent>
              ...
              <Card className="bg-sinergia-card-bg border-sinergia-border-card">
                <CardHeader>
                  <CardTitle className="text-white flex items-center">
                    <Activity className="w-5 h-5 mr-2 text-sinergia-vibrant-cyan" />
                    Atividades Recentes
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {recentActivities.map((activity) => (
                      <div key={activity.id} className="flex items-center justify-between p-4 bg-sinergia-card-bg-light rounded-lg">
                        <div className="flex items-center space-x-4">
                          <div className={`w-3 h-3 rounded-full ${
                            activity.type === 'success' ? 'bg-sinergia-success-green' :
                            activity.type === 'warning' ? 'bg-sinergia-warning-yellow' :
                            'bg-sinergia-vibrant-cyan'
                          }`} />
                          <div>
                            <div className="text-white font-medium">
                              <span className="text-sinergia-vibrant-cyan">{activity.seller}</span> {activity.action}
                            </div>
                            <div className="text-sinergia-light-neutral-gray text-sm">{activity.client}</div>
                          </div>
                        </div>
                        <div className="text-right">
                          {activity.value && (
                          ...
                          <div className="text-sinergia-light-neutral-gray text-sm">{activity.time}</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <Search className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-sinergia-light-neutral-gray" />
                    <input
                      type="text"
                      placeholder="Buscar vendedor..."
                      className="pl-10 pr-4 py-2 bg-sinergia-card-bg-light border border-sinergia-border-card rounded-lg text-white placeholder-sinergia-light-neutral-gray focus:outline-none focus:border-sinergia-vibrant-cyan"
                    />
                  </div>
                  <Button variant="outline" size="sm" className="border-sinergia-border-card text-sinergia-light-neutral-gray hover:bg-sinergia-card-bg">
                ...
                <Button className="bg-gradient-sinergia-button text-sinergia-deep-navy hover:bg-gradient-sinergia-button-hover">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={topPerformers}>
                      ...
                      />
                      <Bar dataKey="sales" fill="var(--sinergia-vibrant-cyan)" />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
          ...
          {selectedTab === 'training' && (
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <Card className="bg-gradient-sinergia-card border-sinergia-border-card">
                  <CardContent className="p-6 text-center">
              ...
              <Card className="bg-white/10 border-white/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {topPerformers.map((seller) => (
                    <Card key={seller.id} className="bg-sinergia-card-bg border-sinergia-border-card">
                      <CardContent className="p-6 flex items-center space-x-4">
                        <div className="w-12 h-12 rounded-full bg-sinergia-vibrant-cyan flex items-center justify-center text-sinergia-deep-navy text-xl font-bold">
                          {seller.avatar}
                        </div>
                        <div className="flex-1">
                          <div className="text-white font-semibold">{seller.name}</div>
                          <div className="text-sinergia-light-neutral-gray text-sm">{seller.level}</div>
                          <div className="flex items-center space-x-2 mt-1">
                            <Badge className={`bg-sinergia-card-bg-light border-sinergia-border-card text-sinergia-vibrant-cyan`}>
                              R$ {(seller.sales / 1000).toFixed(0)}K
                            </Badge>
                            <Badge className={`bg-sinergia-card-bg-light border-sinergia-border-card text-sinergia-success-green`}>
                              {seller.conversion}% Conv.
                            </Badge>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-white font-bold">{seller.streak} Dias</div>
                          <div className="text-sinergia-light-neutral-gray text-xs">Sequência</div>
                        </div>
                      </CardContent>
                    </Card>
                  ))}
