...
const businessTypes = [
  { id: 'clinic', name: 'Clínica/Consultório', icon: '🏥', description: 'Área da saúde e bem-estar', avgRevenue: 45000 },
  { id: 'accounting', name: 'Escritório Contábil', icon: '📊', description: 'Serviços contábeis e fiscais', avgRevenue: 35000 },
  { id: 'ecommerce', name: 'E-commerce/Varejo', icon: '🛒', description: 'Vendas online e físicas', avgRevenue: 80000 },
  { id: 'services', name: 'Serviços Profissionais', icon: '💼', description: 'Consultoria e prestação de serviços', avgRevenue: 55000 },
  { id: 'education', name: 'Educação', icon: '🎓', description: 'Escolas e cursos', avgRevenue: 40000 },
  { id: 'restaurant', name: 'Restaurante/Food', icon: '🍽️', description: 'Alimentação e delivery', avgRevenue: 60000 },
  { id: 'real_estate', name: 'Imobiliária', icon: '🏠', description: 'Mercado imobiliário', avgRevenue: 70000 },
  { id: 'beauty', name: 'Beleza/Estética', icon: '💄', description: 'Salões e clínicas estéticas', avgRevenue: 30000 },
  { id: 'law', name: 'Escritório de Advocacia', icon: '⚖️', description: 'Serviços jurídicos', avgRevenue: 65000 },
  { id: 'automotive', name: 'Oficina/Concessionária', icon: '🚗', description: 'Setor automotivo', avgRevenue: 85000 }
]

const painPoints = [
  { id: 'lead_qualification', name: 'Qualificação de Leads', impact: 'Alto', time: '15h/semana', costPerHour: 45 },
  { id: 'customer_service', name: 'Atendimento ao Cliente', impact: 'Alto', time: '25h/semana', costPerHour: 35 },
  { id: 'scheduling', name: 'Agendamentos', impact: 'Médio', time: '8h/semana', costPerHour: 30 },
  { id: 'follow_up', name: 'Follow-up de Clientes', impact: 'Alto', time: '12h/semana', costPerHour: 40 },
  { id: 'reporting', name: 'Relatórios e Análises', impact: 'Médio', time: '10h/semana', costPerHour: 50 },
  { id: 'inventory', name: 'Gestão de Estoque', impact: 'Médio', time: '6h/semana', costPerHour: 35 },
  { id: 'billing', name: 'Cobrança e Faturamento', impact: 'Alto', time: '8h/semana', costPerHour: 45 },
  { id: 'marketing', name: 'Marketing e Campanhas', impact: 'Médio', time: '12h/semana', costPerHour: 55 },
  { id: 'document_management', name: 'Gestão de Documentos', impact: 'Médio', time: '7h/semana', costPerHour: 40 },
  { id: 'quality_control', name: 'Controle de Qualidade', impact: 'Alto', time: '10h/semana', costPerHour: 60 }
]
