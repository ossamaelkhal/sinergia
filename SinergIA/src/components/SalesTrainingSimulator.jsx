      ...
      steps: [
        {
          ...
          options: [
            {
              text: "Oi Maria! Eu sou João da SinergIA, temos uma solução incrível de IA para você!",
              score: 2,
            ...
            {
              text: "Oi, sou da SinergIA. Vi que você tem uma loja online e posso te ajudar a automatizar.",
              score: 5,
          ...
          {!isActive && currentStep === 0 && (
            <div className="mb-8">
              ...
              <div className="text-center mt-8">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-primary-blue to-secondary-blue hover:from-primary-blue/90 hover:to-secondary-blue/90 text-white font-semibold px-8 py-4 rounded-xl shadow-2xl transform hover:scale-105 transition-all duration-300 group"
